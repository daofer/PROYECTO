<?php
	...
	class Habitacion_model{
		...
		public function listar(){	
			try {				
				$sql = "select *from habitacion inner join tipo_habitacion on(habitacion.h_tipohabitacion=tipo_habitacion.th_id) where habitacion.h_estado=1";
		...
		public function guardar(){	
			try {	
				if($_POST["id"]==""){
					$sql = "insert into habitacion(h_descripcion,h_nro,h_tipohabitacion) values(
						'".$_POST["descripcion"]."',
						'".$_POST["nro"]."',
